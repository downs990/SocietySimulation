...
The long term objective for this project is to configure an environment with a desired society and observe how that society evolves over multiple generations and see how they develop unique traits based on random historic events.
